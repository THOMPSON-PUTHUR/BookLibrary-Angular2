...
export class RestApisService {
    ...
    editUsers: any = {
        'url': '/user/editUsers', 'method': 'GET', 'headers': {}, 'data': null
    };

    userProfile: any = {
        'url': '/user/userprofile', 'method': 'POST', 'headers': {}, 'data': null
    };

    getUserProfile: any = {
        'url': '/user/getuserprofile', 'method': 'GET', 'headers': {}, 'data': null
    };

    deleteUserProfile: any = {
        'url': '/user/deleteuserprofile', 'method': 'DELETE', 'headers': {}, 'data': null
    };

    getUserProfiles: any = {
        'url': '/user/getuserprofiles', 'method': 'GET', 'headers': {}, 'data': null
    };
